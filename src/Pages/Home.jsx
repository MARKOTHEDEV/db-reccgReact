...
const Home = () => {
    return (
        <div>
           ...
           Lorem ipsum, dolor sit amet consectetur adipisicing elit. Totam soluta dicta in molestias voluptatibus magni, minus iusto quidem. Nam recusandae expedita officia! Ducimus et recusandae officia esse, alias facere hic.  
        </div>
    )
}
